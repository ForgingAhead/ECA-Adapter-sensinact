...
/**
 * This is the item provider adapter for a {@link nii.bigclout.ecaadapter.dsl.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trigger_resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trigger_resource_feature", "_UI_Trigger_type"),
				 DslPackage.Literals.TRIGGER__RESOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DslPackage.Literals.TRIGGER__STATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.TRIGGER__STATE,
