...
/**
 * This is the API contained in the sensinact platform which is used to react upon solutions provided by the NII's 
 * ECA Adapter for conflict resolution/adaptation.
 * This interface is supposed to be used by the ECA Adapter to solve conflicts.
 * @author Feng
 *
 */
public interface ConflictAdaptation {
